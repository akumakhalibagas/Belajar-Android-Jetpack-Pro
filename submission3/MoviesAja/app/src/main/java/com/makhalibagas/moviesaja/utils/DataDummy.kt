...
object DataDummy {
    ...
    fun listMoviesDummyAja(): List<MoviesAjaEntity> {
        val listMovie = ArrayList<MoviesAjaEntity>()
    ...
    fun listTvShowsDummyAja(): List<TvShowsAjaEntity> {
        val listTvShow = ArrayList<TvShowsAjaEntity>()
